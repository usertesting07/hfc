$(document).ready(function(){
    ...
    //Hilary's coteries
    var selectedTitles = ['skin care', 'personal care', 'hair care', 'wedding hairstyles and makeup', 'makeup', 'art education resources', 'science resources', 'industrial design', 'cultural architecture', 'fragrance', 'articles', 'herb recipes', 'packaging and label', 'breakfast and brunch', 'diet and nutrition', 'mental health', 'drinks', 'science', 'sandwiches', 'breakfast', 'typography', 'paintings', 'resin', 'ceramics', 'logo and identity', 'lawn and garden', 'other meat recipes', 'web and app design', 'healthy recipes', 'photography tips']
    var unselectedTitles = ['earrings', 'birds', 'salad', 'history', 'mixed media', 'vegetable recipes', 'social studies resources', 'snacks', 'wedding rings', 'blankets', 'running', 'vegetarian recipes', 'bracelets', 'street art', 'printmaking', 'sporting goods', 'inspirational quotes', 'motor vehicles', 'outdoor sports', 'travel destinations', 'wisdom', 'designers', 'fruit', 'photojournalism', 'travel ideas', 'rings', 'budgeting', 'mens fashion', 'music', 'family quotes']
